...
var $ = /* @__PURE__ */ __name((e, t, a) => (a = e != null ? se(ie(e)) : {}, oe(t || !e || !e.__esModule ? U(a, "default", { value: e, enumerable: true }) : a, e)), "$");
var g;
var l = T(() => {
  g = { collectedLocales: [] };
});
...
async function z(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let n = globalThis[ge], r = /* @__PURE__ */ __name(async () => {
          let o = await e.json();
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.6502410661987601.mjs.map
